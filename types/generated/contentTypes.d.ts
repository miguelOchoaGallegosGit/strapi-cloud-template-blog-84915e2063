...
export interface ApiOrdenOrden extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    statusOrden: Schema.Attribute.Enumeration<
      ['Recibido', 'En Proceso', 'Cerrado']
    > &
    Schema.Attribute.DefaultTo<'Recibido'>;
    totalAdvance: Schema.Attribute.Decimal & Schema.Attribute.Required;
    totalAmount: Schema.Attribute.Decimal & Schema.Attribute.Required;
    totalBalance: Schema.Attribute.Decimal & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    Schema.Attribute.Private;
  };
